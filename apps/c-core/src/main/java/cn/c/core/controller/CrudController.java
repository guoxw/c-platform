...
//	}
	...
	public ModelAndView create(@ModelAttribute T t, ModelAndView modelAndView) {
		modelAndView.setViewName(this.getPrefix() + this.getUriDirector() + FORM_PATH);
		this.initForm(t);
...
//	}
	...
	public ModelAndView view(@PathVariable("id") Long id, ModelAndView modelAndView) {
		modelAndView.setViewName(this.getPrefix() + this.getUriDirector() + VIEW_PATH);
		T t = this.getService().findOne(id);
	...
	public ModelAndView save(@Valid @ModelAttribute("entity") T t, BindingResult br, ModelAndView modelAndView) {
		modelAndView.setViewName("redirect:edit/"+t.getId());
		if (br.hasErrors()) {
			modelAndView.setViewName(this.getPrefix() + this.getUriDirector() + FORM_PATH);
...
//	}
	...
	@RequestMapping(value = {"/list/ajax", "/page/ajax"}, method = RequestMethod.GET)
	@ResponseBody
